  ...
  return [
    {
      ...
      entries: [
        ...
        { keys: "Home / End", desc: "Line start / end (Ctrl+A / Ctrl+E)" },
        { keys: "Ctrl/Alt+Home-End", desc: "Start / end of the whole message" },
        { keys: "Alt+← / Alt+→", desc: "Move by word (also Ctrl+arrows, Alt+B / Alt+F)" },
        { keys: "Alt+⌫ / Ctrl+W", desc: "Delete the word before the cursor" },
        { keys: "Alt+D / Alt+Del", desc: "Delete the word after the cursor" },
