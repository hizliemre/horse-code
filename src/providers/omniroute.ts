...
// The failure taxonomy is not this transport's — see src/core/failures.ts.
import { isCapabilityError, isProviderOutage, isUnknownModelError, isCatalogRejection } from "../core/failures.js";
export { isCapabilityError, isProviderOutage, isUnknownModelError, isCatalogRejection };
